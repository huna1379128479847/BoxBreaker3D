...
namespace HighElixir
{
    public static class EnumWrapper
    {
        ...
        public static Dictionary<T, TValue> GetValueConvertedMap<T, TValue>(Func<T, TValue> func, bool skipDefault = true) where T : struct, Enum =>
            GetEnumerable<T>(skipDefault).ToDictionary(v => v, v => func(v));
