...
namespace BlockBreaker3D.Models
{
    public class SurfaceBehaviour : ObjectBase
    {
        ...
        public Surface SurfaceData { get; private set; }
        ...
        public override IObject SurfaceObject { get => _surface ??= this; set => _surface = value; }
        #endregion
        ...
        public void Constract(SignalBus sig)
        {
            ...
            if (_blockRemainText != null)
            {
                ...
                _blockRemainText.transform.rotation = Quaternion.Euler(_camRotate);
        ...
        public Vector3 SurfaceLocalToWorld(Vector2 localPos)
        {
            ...
            return SurfaceData.LocalToWorld(SurfaceOrigin, localPos);
        }
        ...
        {
            return SurfaceData.WorldToLocal(SurfaceOrigin, worldPos);
        }
        ...
        {
            return SurfaceData.UVToWorld(SurfaceOrigin, uv, _size);
        }
        ...
        private void UpdateBlockRemainText()
        {
            ...
            {
                _blockRemainText.text = rm.ToString();
            }
        }
        #endregion
        ...
        {
            _boxBehaviour.CheckClear();
            if (GetBlockCount() == 0 && _enableSlowMotion)
